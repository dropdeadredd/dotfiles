...
local mappings = {
  ...
  a = {
    ...
    c = { "<cmd>VimtexCountWords!<CR>"        , "count" },
    g = { "<cmd>e ~/.config/nvim-LaTeX/templates/Glossary.tex<CR>", "edit glossary"},
    ...
    s = { "<cmd>e ~/.config/nvim-LaTeX/snippets/tex.snippets<CR>", "edit snippets"},
  ...
  t = {
    ...
    p = { 
      "<cmd>read ~/.config/nvim-LaTeX/templates/PhilPaper.tex<CR>", 
      "PhilPaper.tex",
    },
    l = { 
      "<cmd>read ~/.config/nvim-LaTeX/templates/Letter.tex<CR>",
      "Letter.tex",
    },
    g = { 
      "<cmd>read ~/.config/nvim-LaTeX/templates/Glossary.tex<CR>", 
      "Glossary.tex",
    },
    h = { 
      "<cmd>read ~/.config/nvim-LaTeX/templates/HandOut.tex<CR>", 
      "HandOut.tex",
    },
    b = { 
      "<cmd>read ~/.config/nvim-LaTeX/templates/PhilBeamer.tex<CR>", 
      "PhilBeamer.tex",
    },
    s = { 
      "<cmd>read ~/.config/nvim-LaTeX/templates/SubFile.tex<CR>", 
      "SubFile.tex",
    },
    r = { 
      "<cmd>read ~/.config/nvim-LaTeX/templates/Root.tex<CR>", 
      "Root.tex",
    },
    m = { 
      "<cmd>read ~/.config/nvim-LaTeX/templates/MultipleAnswer.tex<CR>", 
      "MultipleAnswer.tex",
    },
  },
}
